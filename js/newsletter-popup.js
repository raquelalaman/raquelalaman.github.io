...
(function() {
    ...
    // Inicialitzar el popup DESPRÉS que tot s'hagi carregat
    window.addEventListener('load', () => {
        // Esperar 1 segon més després del load complet
        setTimeout(() => {
            console.log('🚀 Inicialitzant popup després del load complet');
            init();
        }, 1000);
    });
})();
